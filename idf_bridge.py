...
def generate_idf_structure(project_json: str) -> str:
    ...
    lines.append("      IF CurrentTime > 13.9 && CurrentTime <= 16.0,")
    ...
    lines.append("EnergyManagementSystem:Actuator,")
    lines.append("    Fan_Speed_Act,           !- Name")
    lines.append("    ERV_DCV_Fraction,        !- Actuated Component Unique Name")
    lines.append("    Schedule:Constant,       !- Actuated Component Type")
    lines.append("    Schedule Value;          !- Actuated Component Control Type\n")
    ...
    lines.append("      SET Fan_Speed_Act = 0.1,")
    lines.append("    ELSEIF CO2_PPM > 900,")
    lines.append("      SET Fan_Speed_Act = 1.0,")
    lines.append("    ELSE,")
    lines.append("      SET Fan_Speed_Act = 0.1 + ((CO2_PPM - 450) / 450) * 0.9,")
    lines.append("    ENDIF;\n")
    ...
    lines.append("Controller:MechanicalVentilation,")
    lines.append("    Lab_Vent_Controller,     !- Name")
    lines.append("    ERV_DCV_Fraction,        !- Availability Schedule Name")
    lines.append("    Yes,                     !- Demand Controlled Ventilation")
    lines.append("    IndoorAirQualityProcedure,!- Baseline Method")
    lines.append("    ,                        !- Event Method")
    lines.append("    MainZone,                !- Zone 1 Name")
    lines.append("    Lab_OutdoorAir_Spec;     !- Design Specification Outdoor Air Object Name 1\n")
    ...
    lines.append("    ,                        !- Zone Exhaust Air Node Name")
